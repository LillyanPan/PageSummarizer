...
void loop(){
  static long bpm, ir;
  float ps02;
  unsigned int bpm_ret, ir_ret, ps02_ret;
...
void readPulseSensor(unsigned int* BPM_return, unsigned int* IR_return, unsigned int* PS02_return) {
